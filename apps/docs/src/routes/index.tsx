    ...
    <div className="stax-home">
      ...
      <nav className="stax-nav">
        <div className="stax-nav__inner">
          ...
          <div className="stax-nav__links">
            ...
            <Link to="/docs/$" params={{ _splat: "spec" }} className="stax-nav__link no-underline">
              Spec
            </Link>
            <Link to="/docs/$" params={{ _splat: "cli" }} className="stax-nav__link no-underline">
              CLI
            </Link>
            <a
      ...
      <section className="stax-hero">
        ...
        <div className="stax-hero__actions animate-[fade-up_0.5s_ease_0.18s_both]">
          ...
          <div className="stax-btn-install" aria-label="Install command">
        ...
        <div className="stax-hero__terminal animate-[fade-up_0.5s_ease_0.24s_both]">
          <div className="stax-terminal">
            <div className="stax-terminal__chrome">
              <div className="stax-terminal__dots">
                <span />
                <span />
                <span />
              </div>
      ...
      <footer className="stax-footer">
        ...
        <a href="https://stakpak.dev" target="_blank" rel="noopener">
          by stakpak
        </a>
      </footer>
    </div>
