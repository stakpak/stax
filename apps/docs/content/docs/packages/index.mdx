...
<Cards>
  <Card title="Defining an Agent" href="/docs/packages/define-agent" description="Full reference for defineAgent() including identity, layers, adapters, secrets, and hints" />
  <Card title="Defining a Package" href="/docs/packages/define-package" description="Create reusable bundles of skills, rules, MCP config, and knowledge" />
  <Card title="Defining a Persona" href="/docs/packages/define-persona" description="Author rich persona definitions with traits, communication style, and prompt templates" />
</Cards>
