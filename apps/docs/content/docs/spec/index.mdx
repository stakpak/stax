...
<Cards>
  <Card title="Agent Manifest" href="/docs/spec/agent-manifest" description="The root manifest and compiled config blob (Spec 01)" />
  <Card title="OCI Artifact Format" href="/docs/spec/oci-artifact-format" description="OCI manifests, media types, annotations, and referrers (Spec 02)" />
  <Card title="Layers" href="/docs/spec/layers" description="Deterministic layer construction and validation (Spec 03)" />
  <Card title="Packages" href="/docs/spec/packages" description="Shared config bundles, dependency resolution, and merge rules (Spec 05)" />
  <Card title="Adapters" href="/docs/spec/adapters" description="Runtime adapters and feature contracts (Spec 12)" />
  <Card title="Materialization" href="/docs/spec/materialization" description="Consumer contract for translating artifacts to runtime-native files (Spec 15)" />
</Cards>
...
<Cards>
  <Card title="01 — Agent Manifest" href="/docs/spec/agent-manifest" description="The root manifest and compiled config blob" />
  <Card title="02 — OCI Artifact Format" href="/docs/spec/oci-artifact-format" description="OCI manifests, media types, annotations, and referrers" />
  <Card title="03 — Layers" href="/docs/spec/layers" description="Deterministic layer construction and validation" />
  <Card title="04 — Persona" href="/docs/spec/persona" description="Persona format, validation, and prompt templating" />
  <Card title="05 — Packages" href="/docs/spec/packages" description="Shared configuration bundles, dependency resolution, and merge rules" />
  <Card title="16 — Surfaces" href="/docs/spec/surfaces" description="Named prompt/instruction documents for exact runtime file mapping" />
</Cards>
...
<Cards>
  ...
  <Card title="07 — Skills" href="/docs/spec/skills" description="Skill packaging and frontmatter schema" />
  <Card title="08 — Rules" href="/docs/spec/rules" description="Canonical behavioral rules" />
  <Card title="09 — Knowledge" href="/docs/spec/knowledge" description="Knowledge packaging and metadata" />
  <Card title="10 — Memory" href="/docs/spec/memory" description="Seed memory and memory snapshot conventions" />
...
<Cards>
  <Card title="12 — Adapters" href="/docs/spec/adapters" description="Runtime adapters and feature contracts" />
  ...
  <Card title="15 — Materialization" href="/docs/spec/materialization" description="Consumer contract for translating artifacts to runtime-native files" />
  <Card title="17 — Runtime File Contracts" href="/docs/spec/runtime-file-contracts" description="Exact file ownership and target mappings for runtime homes" />
</Cards>

### Adapter Specs

<Cards>
  <Card title="18 — @stax/claude-code" href="/docs/spec/adapter-claude-code" description="Exact Claude Code adapter contract" />
  <Card title="19 — @stax/openclaw" href="/docs/spec/adapter-openclaw" description="Exact OpenClaw workspace adapter contract" />
  <Card title="20 — @stax/codex" href="/docs/spec/adapter-codex" description="Exact Codex adapter contract" />
  <Card title="33 — @stax/cursor" href="/docs/spec/adapter-cursor" description="Exact Cursor IDE adapter contract" />
  <Card title="34 — @stax/github-copilot" href="/docs/spec/adapter-github-copilot" description="Exact GitHub Copilot adapter contract" />
  <Card title="35 — @stax/windsurf" href="/docs/spec/adapter-windsurf" description="Exact Windsurf adapter contract" />
  <Card title="36 — @stax/opencode" href="/docs/spec/adapter-opencode" description="Exact OpenCode adapter contract" />
</Cards>

### Extended Specs

<Cards>
  <Card title="21 — OpenClaw Profile" href="/docs/spec/openclaw-profile" description="Portable OpenClaw runtime-profile artifact" />
  <Card title="22 — Workspace Sources" href="/docs/spec/workspace-sources" description="Cacheable source artifacts and agent references" />
  <Card title="37 — Subagents and Agent Bundles" href="/docs/spec/subagents-and-agent-bundles" description="Canonical delegate-agent packaging and handoff metadata" />
  <Card title="38 — Instruction Trees" href="/docs/spec/instruction-trees" description="Canonical path-scoped instruction hierarchies" />
</Cards>

### Forward-Looking Drafts

<Cards>
  <Card title="23 — Registry, Discovery, and Install" href="/docs/spec/registry-discovery-install" description="Draft: search, install plans, channels, and registry discovery" />
  <Card title="24 — Trust, Policy, and Attestations" href="/docs/spec/trust-policy-attestations" description="Draft: signatures, approvals, provenance, revocation, and policy gates" />
  <Card title="25 — Hosted Platform Adapter" href="/docs/spec/hosted-platform-adapter-contract" description="Draft: non-filesystem consumers and hosted platform imports" />
  <Card title="26 — Compatibility Metadata" href="/docs/spec/compatibility-and-capability-metadata" description="Draft: preflight compatibility and requirement summaries" />
  <Card title="27 — Package Marketplace Metadata" href="/docs/spec/package-and-marketplace-metadata" description="Draft: ecosystem and catalog metadata" />
  <Card title="28 — Conformance and Certification" href="/docs/spec/conformance-and-certification" description="Draft: interoperability testing and certification" />
  <Card title="30 — Package and MCP Safety Policy" href="/docs/spec/package-and-mcp-safety-policy" description="Draft: package and MCP allow/deny policy" />
  <Card title="99 — Roadmap" href="/docs/spec/roadmap" description="Status map for 1.0.0, forward drafts, and implementation order" />
</Cards>
