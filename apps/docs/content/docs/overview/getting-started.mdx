...
✓ resolved 0 packages
✓ built 6 layers (8.2 KB)
✓ artifact cached — sha256:a3f8c1…e7d2
```

The build compiles your TypeScript definitions, resolves any package dependencies, produces deterministic OCI layers, and stores the artifact in your local cache at `~/.stax/cache/`.
...
```text
✓ pulled ghcr.io/yourorg/backend-engineer:1.0.0
✓ selected adapter: claude-code
✓ materialized — 4 files written to ./workspace
```
