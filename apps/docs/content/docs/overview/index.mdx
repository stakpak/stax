...
<Cards>
  <Card
    title="Philosophy"
    href="/docs/overview/philosophy"
    description="Why agents need a distribution standard and the core thesis behind stax"
  />
  <Card
    title="Architecture"
    href="/docs/overview/architecture"
    description="Core objects, the seven jobs, and conformance levels"
  />
  <Card
    title="Roadmap"
    href="/docs/overview/roadmap"
    description="Implementation status and what's coming next"
  />
</Cards>
...
<Callout type="idea" title="The stax insight">
  Today an "agent" is usually a pile of files tied to one tool. **stax turns that into a real
  artifact** — versioned, portable, verifiable, and distributable.
</Callout>
...
<Cards>
  ...
  <Card
    title="Bundling"
    description="Package the canonical brain: persona, prompt, skills, rules, MCP, knowledge"
  />
  <Card
    title="Dependencies"
    description="Express portable dependencies on packages and source artifacts"
  />
  <Card
    title="Packaging"
    description="Build reusable agent packages for shared behavior and context"
  />
  <Card
    title="Publishing"
    description="Push to OCI registries with versioning and content addressing"
  />
  <Card title="Verification" description="Sign and verify supply chain integrity with Sigstore" />
  <Card
    title="Promotion"
    description="Promote artifacts across dev, staging, and production environments"
  />
  <Card
    title="Materialization"
    description="Translate artifacts into runtime-native formats for any target"
  />
