...
<Cards>
  <Card title="1. Agent Artifacts" description="The canonical brain: persona, prompt, instruction trees, surfaces, subagents, MCP servers, skills, rules, knowledge, memory, secret declarations, and adapter metadata." />
  <Card title="2. Package Artifacts" description="Reusable bundles of shared behavior: org standards, domain toolkits, compliance rules, skill packs, knowledge packs, and MCP packs." />
  <Card title="3. Source Artifacts" description="Cacheable workspace or repository snapshots consumed by many agents." />
  <Card title="4. Runtime Profile Artifacts" description="Portable, non-secret runtime defaults that should not live inside the agent brain." />
  <Card title="5. Referrer Artifacts" description="Metadata attached after publication: signatures, evaluations, approvals, memory snapshots, provenance, and policy attestations." />
</Cards>
