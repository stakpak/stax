...
This produces the minimum viable artifact, package, source, and materialization story.
...
This proves stax can actually install into real runtimes with high fidelity. The new adapters cover the major IDE and terminal agent runtimes: Cursor (33), GitHub Copilot (34), Windsurf (35), and OpenCode (36).
...
This turns stax from a packaging spec into a usable distribution system.

### Phase 4: Cloud and policy readiness
...
- 23 depends on the existence of artifact/package identity from 00–22
...
- 28 depends on the normative core and the exact runtime contracts in 17–20, 33–36
...
8. 17–22, 33–36 depending on target runtime
